    ...
    $('.voce-onepage').each(function(){
        ...
        if( $desc.length ) {
            ...
            if( descHeight > 80 ){
                ...
                $desc.css({height: '100px', overflow: 'hidden', position: 'relative', paddingBottom: '40px', transition: 'all ease-in-out 0.3s'});
...
$(document).ready(function(){      
	...
	function init_template(){
        ...
        */
        ...
        $('.contactWhatsApp').prop("href", "whatsapp://send?phone=" + tel_num)
